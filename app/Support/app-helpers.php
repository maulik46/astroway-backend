...
/*
    ...
    *-------------------------------------------------------- */
     ...
     function authcheck()
    {
        ...
        ])->post(env('APP_URL').'/api/getUserdetails', []);



        return isset($response['userDetails'])?$response['userDetails']:false;

        // return isset($response['error']) && $response['error'] !== 'Unauthorized';
