    ...
    public function getChatRequest(Request $req)
    {
        try {
            ...
            $chatRequest = DB::table('chatrequest')
                ...
                ->selectRaw('users.*,chatrequest.id as chatId,chatrequest.senderId,user_device_details.fcmToken, chatrequest.chat_duration');
    ...
    public function intakeForm(Request $req)
    {
        try {
            ...
            $intakeForm = array(
                ...
                'birthTime' => $req->birthTime ? $req->birthTime : '',
                'birthPlace' => $req->birthPlace ? $req->birthPlace : '',
                'maritalStatus' => $req->maritalStatus,
                'occupation' => $req->occupation ? $req->occupation : '',
