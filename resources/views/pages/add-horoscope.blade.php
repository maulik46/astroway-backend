                        ...
                        <div class="preview">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input" id="classic-editor" style="margin-top:10px">
                                    <textarea class="form-control ml-3" id="weeklydesc" name="weeklydesc"></textarea>
                                </div>
                            </div>
                            <div class="mt-3">
                                <div>
                                ...
                                <div class="input" id="classic-editor" style="margin-top:10px">
                                    <textarea class="form-control ml-3" id="monthlydesc" name="monthlydesc"></textarea>
                                </div>
                            </div>
                            <div class="mt-3">
                                <div>
                                ...
                                <div class="input" id="classic-editor" style="margin-top:10px">
                                    <textarea class="form-control ml-3" id="yearlydesc" name="yearlydesc"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
