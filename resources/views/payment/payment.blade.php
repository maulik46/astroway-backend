...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#lwPaymentForm').on('submit', function(e) {
            ...
            if (paymentOption == 'paypal' || paymentOption == 'paytm' || paymentOption == 'instamojo' || paymentOption == 'iyzico' || paymentOption == 'authorize-net' | paymentOption == 'mercadopago' || paymentOption == 'payumoney' || paymentOption == 'mollie' || paymentOption == 'pagseguro' || paymentOption == 'coingate' || paymentOption == 'twoCheckout') {
